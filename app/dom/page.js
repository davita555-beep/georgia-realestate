...
const T = {
  ka: {
    ...
    heroSub:      "დიდხანს გაყიდვაში მყოფი ბინები — ყველაზე ხელსაყრელი მოლაპარაკების შანსი",
          ...
          {!unlocked && highDomListings.length > 0 && (
            <div style={{ textAlign: "center", marginTop: 24 }}>
              <p style={{ color: "#64748B", fontSize: 14, marginBottom: 12 }}>
                {lang === "ka"
                  ? "აღმოაჩინე შეთავაზებები, რომლებიც უმეტეს მყიდველს გამორჩება. იმოქმედე მონაცემებით — არა ინტუიციით."
