    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-blue-700 text-white px-6 py-16">
        <div className="max-w-4xl mx-auto">
          <p className="text-blue-300 text-sm mb-2">Tbilisi / Ponichala</p>
          <h1 className="text-4xl font-bold mb-2">პონიჭალა — Ponichala</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
              <p className="text-4xl font-bold text-blue-700">$750</p>
          ...
          <div className="bg-white rounded-xl p-8 border border-gray-200 mb-8">
            ...
            <div className="space-y-3">
              <div className="bg-gray-100 rounded-lg px-4 py-3 flex justify-between">
                ...
                <span className="font-bold">$750/sqm</span>
              </div>
              <div className="bg-blue-50 rounded-lg px-4 py-3 flex justify-between">
                ...
                <span className="font-bold">$847/sqm</span>
              </div>
              <div className="bg-green-50 rounded-lg px-4 py-3 flex justify-between">
                ...
                <span className="font-bold">$885/sqm</span>
              </div>
              <div className="bg-amber-50 rounded-lg px-4 py-3 flex justify-between">
                ...
                <span className="font-bold">$990/sqm</span>
              </div>
            </div>
          </div>
